...
import logging
from add_patterns import VideoPatternApp
import logging
...
class MPPatternApp(VideoPatternApp):
   
    def __init__(self, input_video, initial_detect=True, crop_padding=30, alpha=0.5, frequency=4, target_landmarks=[50, 280, 109, 338], pattern_rel_width=.2, pattern_color=(255, 255, 0), log_level='INFO'):
        VideoPatternApp.__init__(self, input_video, initial_detect, crop_padding, alpha, frequency, target_landmarks, pattern_rel_width, pattern_color, log_level)
