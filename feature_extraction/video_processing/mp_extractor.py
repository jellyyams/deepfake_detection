...
class MPFeatureExtractor(object):
    ...
    lkeys_to_plot : list of int pairs
    ...
    pairs_to_analyze: list of int tuples
    ...
    landmarks_object: Landmarks object
        A Landmarks class object that contains attributes and methods for naming, sorting, and selecting landmarks
    bbox: dict
        tracks the bbox of the current frame
    landmarks: dict
        a dict of landmarks, speparated into upper and lower regions of the face for norming
    ...
    def __init__(
        ...
        self.landmarks_object = Landmarks()
        self.bbox = {
            "upper":[(0,0,0), (0,0,0)], 
            "lower": [(0,0,0), (0,0,0)], 
            "face": [(0,0,0), (0,0,0)]
        ...
        self.landmarks = {
            "upper": self.landmarks_object.upper_landmarks, 
            "lower": self.landmarks_object.lower_landmarks, 
            "face": self.landmarks_object.all
        }
    ...
    def plot_landmarks(self, landmarks): 
        ...
        if len(landmarks) != 0: 
            ...
            # self.vidgen.set_plot_frame(self.frame_num, self.target_landmarks, self.landmark_data_tracker)
            self.vidgen.set_plot_pairs_frame(self.frame_num, self.lkeys_to_plot, self.landmark_group_tracker)
        else: 
            self.empty_frame()
